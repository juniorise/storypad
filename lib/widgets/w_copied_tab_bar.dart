...
class WCopiedTabBar extends StatefulWidget implements PreferredSizeWidget {
  const WCopiedTabBar({
    Key key,
    @required this.tabs,
    this.controller,
...
class _TabBarState extends State<WCopiedTabBar> {
  ...
  @override
  void didUpdateWidget(WCopiedTabBar oldWidget) {
